...
VIDEO_SOURCE_DICT = {
    "title": "School Food Punishment - RPG",
...
class TestGetYoutubeVideoUseCase:
    ...
    @pytest.mark.asyncio
    async def test_get_youtube_video_with_a_valid_url(self, get_youtube_video_usecase, youtube_video_service_mock):
    ...
    @pytest.mark.asyncio
    async def test_should_returns_a_response_with_error_when_url_is_incorrect(
        self, get_youtube_video_usecase, youtube_video_service_mock
    ):
