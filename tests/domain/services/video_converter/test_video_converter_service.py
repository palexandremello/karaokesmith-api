...
class TestVideoConverterService:
    ...
    @pytest.mark.asyncio
    async def test_should_be_able_to_return_a_response_when_execute_is_successful(
        self, converter_stub: ConverterInterface, video_converter_service: VideoConverterServiceInterface
    ):
        video_source = VideoSource(title="any_title", thumbnail_url="thumbnail_url", path="any_path")
    ...
    @pytest.mark.asyncio
    async def test_should_be_able_to_return_a_response_when_execute_throws(
        self, converter_stub: ConverterInterface, video_converter_service: VideoConverterServiceInterface
    ):
